...
> **Governance Notice** — This pack is governed by the [Stella Maris Constitution (CONST-01)](https://github.com/stella-maris-governance/smg-enterprise-hq) and enforces **POL-SC-01 (Supply Chain) · POL-AC-01 (Access Control) · NIST PS-4, SA-9**. All dispositions are subject to the Two-Person Integrity Protocol.
